...
from db.models import Project, Area, WorkPackage, Activity
from schemas.projects import (
    ProjectCreate, ProjectUpdate, ProjectResponse,
    AreaCreate, AreaUpdate, AreaResponse,
    WorkPackageCreate, WorkPackageUpdate, WorkPackageResponse,
...
create_crud(router, Project, ProjectCreate, ProjectUpdate, ProjectResponse, "/projects")
create_crud(router, Area, AreaCreate, AreaUpdate, AreaResponse, "/areas")
create_crud(router, WorkPackage, WorkPackageCreate, WorkPackageUpdate, WorkPackageResponse, "/work-packages")
create_crud(router, Activity, ActivityCreate, ActivityUpdate, ActivityResponse, "/activities")
